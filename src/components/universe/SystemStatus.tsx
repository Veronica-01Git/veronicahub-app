...
const SYSTEM_STATUS_DATA: StatusItem[] = [
  ...
  { key: "char", label: "CHARACTER BIBLE", status: "ACTIVE", variant: "green" },
  { key: "vis", label: "VISUAL SYSTEM", status: "ACTIVE", variant: "green" },
  { key: "voice", label: "VOICE", status: "ACTIVE", variant: "green" },

  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute inset-y-0 right-0 w-full sm:w-[72%] lg:w-[54%]">
        ...
        <div className="absolute right-[-20%] top-14 w-[76%] bg-black opacity-35 sm:right-[-5%] sm:top-10 sm:w-[72%] sm:opacity-65 lg:right-[7%] lg:top-10 lg:w-[58%] lg:opacity-100">
          <video
            autoPlay
            muted
            loop
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black via-black/10 to-black/30" />

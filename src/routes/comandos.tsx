    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative overflow-hidden border-b border-border/40 py-16 md:py-20">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 20% 0%, oklch(0.85 0.22 155 / 0.18), transparent 55%)",
          }}
        />
                ...
                >
                  <div className="relative -mx-6 -mt-6 mb-6 h-36 overflow-hidden border-b border-border/50">
                    <LazyImage
                      ...
                      className="absolute inset-0 h-full w-full object-cover transition-all duration-700 ease-out group-hover:scale-110 group-hover:[filter:contrast(1.15)_saturate(1.2)] [filter:contrast(1.05)_saturate(0.75)_brightness(0.75)]"
                    />
                    <div
                      aria-hidden
                    ...
                    <div
                      aria-hidden
                      className="pointer-events-none absolute inset-x-0 top-3 h-px bg-neon-green/0 transition-colors duration-300 group-hover:bg-neon-green/70"
                    />
                    <div
                      aria-hidden
                      className="pointer-events-none absolute inset-x-0 bottom-4 h-px bg-neon-cyan/0 transition-colors duration-500 group-hover:bg-neon-cyan/60"
                    />
                    <span
                      aria-hidden
                      className="absolute left-2 top-2 h-3 w-3 border-l border-t border-neon-green/70"
                    />
                    <span
                      aria-hidden
                      className="absolute right-2 top-2 h-3 w-3 border-r border-t border-neon-cyan/70"
                    />

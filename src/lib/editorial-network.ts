...
export const EDITORIAL_CHANNELS: Record<Beat, readonly [EditorialChannel, EditorialChannel]> = {
  ia: [
    ...
    },
    {
      ...
      keywords: ["pesquisa", "cientista", "estudo", "segurança", "regulação", "universidade", "laboratório"],
    },
  ],
  clima: [
    {
      ...
      keywords: ["alerta", "chuva", "vento", "temperatura", "evento extremo", "defesa civil", "previsão"],
    },
    {
      id: "sustentabilidade",
  ...
  mercado: [
    ...
    },
    {
      ...
      keywords: ["investimento", "startup", "rodada", "oportunidade", "mercado", "crescimento", "demanda"],
    },
  ],
};
